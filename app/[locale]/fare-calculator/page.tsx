            ...
            <CardContent className="space-y-5">
              ...
              <div className="space-y-4">
                <StopCombobox
                  label={t("selectFrom")}
                  value={fromStopName}
                  onValueChange={(v) => { setFromStopName(v); setHasCalculated(false); }}
                ...
                <StopCombobox
                  label={t("selectTo")}
                  value={toStopName}
                  onValueChange={(v) => { setToStopName(v); setHasCalculated(false); }}
              ...
              <div className="pt-2">
                <Button
                  ...
                  onClick={() => { if (fromStopName && toStopName && fromStopName !== toStopName) setHasCalculated(true); }}
